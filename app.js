document.addEventListener('DOMContentLoaded', () => {
    ...
    function displayCurrentPage() {
        ...
        renderAdIfNeeded(); // Show ad after page 1 and 2
    }
    ...
    // Render Ad after page 1 and 2
    function renderAdIfNeeded() {
        ...
        // Show ad only on pages 1 and 2
        if (currentPage === 1 || currentPage === 2) {
            adContainer.style.display = 'block';

            // Only inject script once
            if (!adContainer.querySelector('script')) {
                adContainer.innerHTML = '<div style="text-align: center; padding: 2rem 0;"></div>';
                const script = document.createElement('script');
                script.src = 'https://pl26742174.effectivegatecpm.com/02/bd/4d/02bd4d1eb41bb325abf2a5a6b3921799.js';
                script.async = true;
                adContainer.querySelector('div').appendChild(script);
            }
        } else {
