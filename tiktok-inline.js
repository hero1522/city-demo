...
function openVideoModal(startProductImage, productList, startIndex) {
    console.log('openVideoModal called with:', startProductImage);
    ...
    console.log('Found', videoProducts.length, 'video products');
    ...
    console.log('Starting at index:', scrollToIndex);
